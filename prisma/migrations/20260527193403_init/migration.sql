-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('Processing', 'Delivered', 'Cancelled', 'Out for Delivery');

-- CreateEnum
CREATE TYPE "BookFormat" AS ENUM ('physical', 'ebook', 'audio');
...
CREATE TABLE "users" (
    ...
    "membership" TEXT NOT NULL DEFAULT 'Bronze Member',
    "streak" INTEGER NOT NULL DEFAULT 1,
    "poetic_points" INTEGER NOT NULL DEFAULT 10,
...
-- CreateIndex
CREATE UNIQUE INDEX "cart_items_cart_id_product_id_format_key" ON "cart_items"("cart_id", "product_id", "format");
